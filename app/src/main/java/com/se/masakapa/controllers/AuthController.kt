...
object AuthController {
    fun register(email: String?, password: String?, displayName: String?, profilePicture: String?, listener: ListenerAdapter) {
        // Validation here
        UserRepository.register(email, password, object : ListenerAdapter() {
